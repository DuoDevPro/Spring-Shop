...
import com.product_service.service.ImageSerivce;
...
public class ImageController {
    ...
    public ResponseEntity<ApiResponse> saveImages(@RequestParam List<MultipartFile> files, @RequestParam Long productId) {
        try {
            List<ImageDto> imageDtos = imageSerivce.saveImages(productId, files);
    ...
    public ResponseEntity<Resource> downloadImage(@PathVariable Long imageId) throws SQLException {
        Image image = imageSerivce.getImageById(imageId);
    ...
    public ResponseEntity<ApiResponse> updateImage(@PathVariable Long imageId, @RequestBody MultipartFile file) {
        try {
            Image image = imageSerivce.getImageById(imageId);
            if(image != null) {
                imageSerivce.updateImage(file, imageId);
    ...
    public ResponseEntity<ApiResponse> deleteImage(@PathVariable Long imageId) {
        try {
            Image image = imageSerivce.getImageById(imageId);
            if(image != null) {
                imageSerivce.deleteImageById( imageId);
